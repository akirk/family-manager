...
- **Each member sees their own version of a home**: children see only the tasks and rewards assigned to them or to the whole household; organisers (parents and up) see everything and can add tasks and rewards.
